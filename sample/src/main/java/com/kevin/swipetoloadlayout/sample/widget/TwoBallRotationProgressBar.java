package com.kevin.swipetoloadlayout.sample.widget;
 ...
 *
 * @author zwenkai@foxmail.com, Created on 2019-09-30 16:40:02
 * Major Function：<b></b>
 * <p/>
 * 抄自 https://github.com/hanhailong/TwoBallRotationProgressBar
...
public class TwoBallRotationProgressBar extends View {
    ...
    // 默认第一个小球颜色
    private final static int DEFAULT_ONE_BALL_COLOR = Color.parseColor("#FF567C");
    // 默认第二个小球颜色
    private final static int DEFAULT_TWO_BALL_COLOR = Color.parseColor("#FF85A1");
